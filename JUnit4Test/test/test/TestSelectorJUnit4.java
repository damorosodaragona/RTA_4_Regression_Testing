...
//        PREVIOUS_VERSION_PROJECT.saveCallGraph("ProjectForTesting", "old");
        ...
        TestSelector u =new TestSelector(NEW_VERSION_PROJECT,codeAnalyzer.getDifferentMethods() ,codeAnalyzer.getDifferentTest(),codeAnalyzer.getNewMethods() ,codeAnalyzer.getDifferentObject());
