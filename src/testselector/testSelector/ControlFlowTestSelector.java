...
//     * @param alsoNew
//     */
//    public ControlFlowTestSelector(Project previousProjectVersion, Project newProjectVersion, boolean alsoNew) {
...
//            SootMethod test = Util.findMethod(method.getName(), method.getDeclaringClass().getJavaStyleName(), method.getDeclaringClass().getJavaPackageName(), newProjectVersion.getTarget(), newProjectVersion.getClassPath());
...
//                }
//            } else {
//                LOGGER.info("Can't retrieve:" + method.getDeclaringClass() + "." + method.getName());
//
//            }
//        }
...
//                            differentTest.add(new Test(Util.findMethod(sootMethod1.getName(), sootMethod1.getDeclaringClass().getJavaStyleName(), sootMethod1.getDeclaringClass().getPackageName(), newProjectVersion.getTarget(), newProjectVersion.getClassPath())));
...
//
//
//    private void callGraphsAnalyzer(Edge e1, SootMethod entryPoint, ArrayList<Edge> yetAnalyzed, SootMethod test) {
...
//
//
////            SootMethod m1 = e1.getTgt().method();
...
//
//                //retrieve a method from the node (the method at the end so i a node contain a that call b, retrieve b)
//                SootMethod targetMethod = e1.getTgt().method();
