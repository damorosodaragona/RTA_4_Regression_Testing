...
public class Project {
    ...
    public void noDirectory() throws NotDirectoryException, NoTestFoundedException {
        new testselector.project.Project(true, 4, null, "out/production/p/sootTest/CallGraphExample.class");
    }
    ...
    public void saveNoNameCallgraph() throws NoPathException, NotDirectoryException, NoTestFoundedException, NoNameException {
        testselector.project.Project p = new testselector.project.Project(true, 4, classPath, "out/production/p");
    ...
    public void noEntryPoints() throws NotDirectoryException, NoTestFoundedException {
        new testselector.project.Project(true, 4, classPath, "com.company");
    ...
    public void noEquals() throws NotDirectoryException, NoTestFoundedException {
        testselector.project.Project p = new testselector.project.Project(true, 4, classPath, "out/production/p");
        testselector.project.Project p1 = new testselector.project.Project(true, 4, classPath, "out/production/p1");
    ...
    public void equalsHasCode() throws NotDirectoryException, NoTestFoundedException {
        testselector.project.Project p = new testselector.project.Project(true, 4, classPath, "out/production/p");
        testselector.project.Project p1 = new testselector.project.Project(true, 4, classPath, "out/production/p");
