    ...
    public void lunch(){
        ...
        directoryList.forEach(paths -> {
            ...
            try {
                ...
                Project p1 = new NewProject( 4, cls, toExclude.toArray(new String[0]), paths + "\\target\\classes", paths + "\\target\\test-classes");
                ...
                XMLReport xml = new XMLReport(id, end - start, selected, "RTA-logback-withoutLibrary");
                xml.writeOut();
